...
#define TFT_SCL         SPI1_SCK_PA5    //定义SPI_SCK引脚
#define TFT_SDA         SPI1_MOSI_PA7   //定义SPI_MOSI引脚
#define TFT_SDA_IN      SPI_MISO_NULL   //定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define TFT_REST_PIN    C13             //液晶复位引脚定义 由于实际通讯未使用D15因此 这里复用为GPIO
#define TFT_DC_PIN      C14             //液晶命令位引脚定义
#define TFT_CS_PIN      C15             //定义SPI_CS引脚
#define TFT_BL_PIN      PIN_NULL        //液晶背光引脚定义
